...
INSERT INTO "new_CreditCardExpense" ("anticipated", "createdAt", "creditCardExpenseGeneratorId", "creditCardId", "id", "installmentNumber", "invoiceDate", "justForRecord", "name", "paidOut", "totalInstallmentNumber", "updatedAt", "userId", "value") SELECT "anticipated", "createdAt", "creditCardExpenseGeneratorId", "creditCardId", "id", "installmentNumber", "invoiceDate", "justForRecord", "name", "paidOut", "totalInstallmentNumber", "updatedAt", "userId", "value" FROM "CreditCardExpense";
