/*
  ...
  - You are about to drop the column `purchaseDate` on the `CreditCardExpense` table. All the data in the column will be lost.
...
INSERT INTO "new_CreditCardExpense" ("createdAt", "creditCardExpenseGeneratorId", "creditCardId", "id", "invoiceDate", "justForRecord", "name", "paidOut", "paymentEndDate", "updatedAt", "userId", "value") SELECT "createdAt", "creditCardExpenseGeneratorId", "creditCardId", "id", "invoiceDate", "justForRecord", "name", "paidOut", "paymentEndDate", "updatedAt", "userId", "value" FROM "CreditCardExpense";
